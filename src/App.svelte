  ...
  onMount(() => {
    ...
    if (safeStorage.getItem('debugStores')) {
      Promise.all([
        ...
        import('./lib/filePreview'),
        import('./lib/saveAs'),
        import('./lib/windowTabs'),
        ...
        import('./lib/mountedVolumes'),
			import('./lib/storageUsage'),
			import('./lib/scenePrivacy'),
