<script>
  ...
  import CollectibleDialog from './components/menu/CollectibleDialog.svelte'
  ...
  onMount(() => {
    ...
    if (localStorage.getItem('debugStores')) {
      Promise.all([
        ...
        import('./lib/gameRecipes'),
        import('./lib/recipeDialog'),
