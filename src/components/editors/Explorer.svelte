<script lang="ts">
	...
	// 21-I2: the chip's dirty dot. READ, never recomputed here — the answer is a whole-scene
	// serialization and sceneIdentity.js owns the throttle that makes it affordable.
